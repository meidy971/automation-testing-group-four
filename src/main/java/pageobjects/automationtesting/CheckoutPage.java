...
public class CheckoutPage {
    ...
    By bancTransfertPaymentSelector = By.cssSelector(".wc_payment_method.payment_method_bacs");
    ...
    By countrySelector = By.id("select2-chosen-1");
    ...
    By totalPriceSelector = By.cssSelector("tfoot tr + tr +tr >td > strong");
    ...
    public  void setCountyFromCheckoutPage (String county){

        driver.findElement(countySelector).sendKeys(county);
